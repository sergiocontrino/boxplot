...
console.log("s:" + sampleNr + " t:" + tissueNr + " g:" + geneNr + " x:" + xNr + " Max:" + maxE + " log:" + max);
  ...
  // Build the report header
    head = svg.append('foreignObject')
      ...
      //.attr('fill', )
      .append("xhtml:body")
      .html('<h3 class="goog"> ' + sampleNr + ' Time course Expression - source: <a href="https://www.araport.org/">Araport</a></h3>\
             <p> <p>');
}
...
/* generic version with the sample id */
  x = d3.scale.ordinal()
   .domain(d3.map(data, function(d){return (d[5]+"-"+d[6])}).keys())
  ...
  bar.append("a")
    .on("mouseover", function(d, i){
      d3.select(this)
        ...
        .attr({"xlink:title": d[0] + "[" + d[1] + "]" + " - " + d[5] + "-" + d[6] + ": " + d[2]});
    })
    .append("rect")
